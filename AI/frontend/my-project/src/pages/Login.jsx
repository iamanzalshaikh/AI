...
const Login = () => {
    ...
    const googleLogin = async () => {
        try {
            ...
            if (!result?.user) {
                console.error("❌ No user info from Google");
                return;
            }
        ...
        <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2825] text-white flex flex-col items-center overflow-hidden'>
            ...
            <div className='flex flex-col justify-center items-center flex-grow w-full'>
                <div className='text-center'>
                    <h2 className='text-[26px] font-bold'>Login Page</h2>
                    <p className='text-gray-300 text-[15px] mt-1'>Welcome back! Log in to your account</p>
                </div>
                ...
                <div className='w-[90%] max-w-[500px] mt-6 bg-[#00000025] border border-[#96969635] backdrop-blur-xl rounded-lg shadow-md p-6 flex flex-col items-center'>
                    <form onSubmit={handleLogin} className='w-full flex flex-col items-center'>
                        ...
                        {/* Google Login */}
                        <div
                            className='w-[90%] bg-[#4265cae] rounded-lg flex items-center justify-center gap-[10px] py-[14px] cursor-pointer'
                            onClick={googleLogin}
                        >
